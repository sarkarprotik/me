...
const Link = tw.a`border-b-2 border-transparent hocus:text-pink-500 hocus:border-pink-500 pb-1 transition duration-300`;

const LogoContainer = tw.div`flex items-center justify-center md:justify-start`;
const LogoImg = tw.img`w-8`;
const LogoText = tw.h5`ml-2 text-xl font-black text-pink-500`;
      ...
      <FiveColumns>
        <WideColumn>
          <LogoContainer>
            ...
            <LogoText>Protik Sarkar</LogoText>
          </LogoContainer>
          <CompanyDescription>
